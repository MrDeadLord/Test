...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        // Input
        vInput = Input.GetAxisRaw("Left/Right");
        hInput = Input.GetAxisRaw("Forward/Back");
        ...
        if (!enableMovement)
            return;
        inputForce = (transform.forward * vInput + transform.right * hInput).normalized * (Input.GetButton("Run") ? runSpeed : walkSpeed);
